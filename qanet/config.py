...
home = os.getcwd()
train_file = os.path.join(home, "datasets", "law", "train.json")
dev_file = os.path.join(home, "datasets", "law", "dev.json")
test_file = os.path.join(home, "datasets", "law", "dev.json")
glove_word_file = os.path.join(home, "datasets", "w2v", "w2v_veciter10.txt")
...
flags.DEFINE_integer("glove_word_size", 700000, "Corpus size for Glove")
